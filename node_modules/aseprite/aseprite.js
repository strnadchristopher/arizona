...
var Aseprite = (function() {
  ...
  var Header = Aseprite.Header = (function() {
    ...
    Header.prototype._read = function() {
      ...
      this.magic = this._io.ensureFixedContents([224, 165]);
      ...
      this._unnamed10 = this._io.readBitsInt(24);
    ...
    var FlagsBitset = Header.FlagsBitset = (function() {
      ...
      FlagsBitset.prototype._read = function() {
        ...
        this.validOpacity = this._io.readBitsInt(1) != 0;
        this._unnamed2 = this._io.readBitsInt(24);
      }
  ...
  var Frame = Aseprite.Frame = (function() {
    ...
    var Header = Frame.Header = (function() {
      ...
      Header.prototype._read = function() {
        ...
        this.magic = this._io.ensureFixedContents([250, 241]);
    ...
    var Chunk = Frame.Chunk = (function() {
      ...
      Chunk.prototype._read = function() {
        ...
        if (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.COLOR_PROFILE) {
          this.colorProfile = new ColorProfileChunk(this._io, this, this._root);
        }
        if (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.PALETTE) {
          this.palette = new PaletteChunk(this._io, this, this._root);
        }
        if ( ((this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.PALETTE_OLD_1) || (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.PALETTE_OLD_2)) ) {
          this.paletteOld = new PaletteOldChunk(this._io, this, this._root);
        }
        if (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.LAYER) {
          this.layer = new LayerChunk(this._io, this, this._root);
        }
        if (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.CEL) {
          this.cel = new CelChunk(this._io, this, this._root);
        }
        if (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.CEL_EXTRA) {
          this.celExtra = new CelExtraChunk(this._io, this, this._root);
        }
        if (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.SLICE) {
          this.slice = new SliceChunk(this._io, this, this._root);
        }
        if (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.TAGS) {
          this.tags = new TagsChunk(this._io, this, this._root);
        }
        if (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.USERDATA) {
          this.userdata = new UserdataChunk(this._io, this, this._root);
        }
        if (this.type == Aseprite.Frame.Chunk.ChunkTypeEnum.MASK) {
          this.mask = new MaskChunk(this._io, this, this._root);
        }
      }
      ...
      var SliceChunk = Chunk.SliceChunk = (function() {
        ...
        var FlagsBitset = SliceChunk.FlagsBitset = (function() {
          ...
          FlagsBitset.prototype._read = function() {
            this._unnamed0 = this._io.readBitsInt(6);
            this.hasPivot = this._io.readBitsInt(1) != 0;
            this.patch9 = this._io.readBitsInt(1) != 0;
          }
      ...
      var LayerChunk = Chunk.LayerChunk = (function() {
        ...
        var FlagBitset = LayerChunk.FlagBitset = (function() {
          ...
          FlagBitset.prototype._read = function() {
            ...
            this.reference = this._io.readBitsInt(1) != 0;
            this.collapsed = this._io.readBitsInt(1) != 0;
            this.preferLinked = this._io.readBitsInt(1) != 0;
            this.background = this._io.readBitsInt(1) != 0;
            this.lockMovement = this._io.readBitsInt(1) != 0;
            this.editable = this._io.readBitsInt(1) != 0;
            this.visible = this._io.readBitsInt(1) != 0;
            this._io.alignToByte();
        ...
        var Entry = PaletteChunk.Entry = (function() {
          ...
          var FlagBitset = Entry.FlagBitset = (function() {
            ...
            FlagBitset.prototype._read = function() {
              ...
              this._unnamed2 = this._io.readBitsInt(8);
            }
      ...
      var UserdataChunk = Chunk.UserdataChunk = (function() {
        ...
        var FlagsBitset = UserdataChunk.FlagsBitset = (function() {
          ...
          FlagsBitset.prototype._read = function() {
            this._unnamed0 = this._io.readBitsInt(6);
            this.hasColor = this._io.readBitsInt(1) != 0;
            this.hasText = this._io.readBitsInt(1) != 0;
            this._unnamed3 = this._io.readBitsInt(24);
          }
      ...
      var ColorProfileChunk = Chunk.ColorProfileChunk = (function() {
        ...
        ColorProfileChunk.prototype._read = function() {
          ...
          this._unnamed3 = this._io.readBytes(8);
          if (this.type == Aseprite.Frame.Chunk.ColorProfileChunk.TypeEnum.ICC) {
        ...
        var Flags = ColorProfileChunk.Flags = (function() {
          ...
          Flags.prototype._read = function() {
            this._unnamed0 = this._io.readBitsInt(7);
            this.fixedGamma = this._io.readBitsInt(1) != 0;
            this._unnamed2 = this._io.readBitsInt(8);
          }
      ...
      var CelExtraChunk = Chunk.CelExtraChunk = (function() {
        ...
        var FlagsBitset = CelExtraChunk.FlagsBitset = (function() {
          ...
          FlagsBitset.prototype._read = function() {
            this._unnamed0 = this._io.readBitsInt(7);
            this.preciseBounds = this._io.readBitsInt(1) != 0;
          }
